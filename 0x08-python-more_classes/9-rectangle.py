...
The 9-rectangle module defines the Rectangle class.
"""
...
class Rectangle:
    ...
    a static method bigger_or_equal to return the biggest rectangle based on the area, and a class method square to return a new Rectangle instance with width == height == size.
    """
