...
The 7-rectangle module defines the Rectangle class.
"""
...
class Rectangle:
    ...
    a __del__ method to print a message when an instance is deleted, and public class attributes number_of_instances and print_symbol.
    """
