...
The 6-rectangle module defines the Rectangle class.
"""
...
class Rectangle:
    ...
    a __del__ method to print a message when an instance is deleted, and a public class attribute number_of_instances.
    """
